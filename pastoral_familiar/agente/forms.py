...
from wtforms import TextField, HiddenField, BooleanField, DateField
...
class AgenteForm(Form):
    ...
    sexo = SelectField(u'Sexo', choices=[('', 'Selecione...'), ('M', 'Masculino'), ('F', u'Feminino')], validators=[validators.Required(u'Você precisa selecionar o sexo!')], coerce=unicode)
    ...
    id_nucleo = SelectField(u'Núcleo', [validators.Required(
        u'Você precisa selecionar um núcleo')], coerce=int)
...
class AgenteFormInserir(AgenteForm):
    ...
    password_confirm = PasswordField('Confirmar Senha', [validators.DataRequired(u'Você precisa digitar a senha!'),
                                                         validators.Length(max=50)])
